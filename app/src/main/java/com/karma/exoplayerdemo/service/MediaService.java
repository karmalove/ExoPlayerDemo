package com.karma.exoplayerdemo.service;
...
import com.karma.exoplayerdemo.Constants;
import com.karma.exoplayerdemo.MainActivity;
import com.karma.exoplayerdemo.R;
import com.karma.exoplayerdemo.player.ExoPlayerAdapter;
import com.karma.exoplayerdemo.player.PlayBackInfoListener;
...
import static com.karma.exoplayerdemo.Constants.MEDIA_QUEUE_POSITION;
import static com.karma.exoplayerdemo.Constants.QUEUE_NEW_PLAYLIST;
...
//        }
    ...
    public class GetMediaData extends AsyncTask<Integer, Void, MediaMetadataCompat> {
        ...
        protected MediaMetadataCompat doInBackground(Integer... integers) {
            ...
            MediaMetadataCompat dataCompat= new MediaMetadataCompat.Builder().putString(MediaMetadataCompat.METADATA_KEY_MEDIA_URI,"http://nos.netease.com/test-open-audio/nos/mp3/2017/12/04/AT08IH87FHUG1LNA_sd.mp3").build();//TODO: audio quality: shared preference
    ...
    public class MediaSessionCallback extends MediaSessionCompat.Callback {//media controller 给这个发信号
        ...
        private void getmPreparedMedia(Integer avid, final GetMediaCallBack callBack) {
        ...
        @Override
        public void onPlayFromMediaId(String mediaId, final Bundle extras) {//给一个mediaId，然后就play
